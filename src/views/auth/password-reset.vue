            ...
            <div class="container">
              ...
              <d-row>
                ...
                <d-col md="12" lg="12" sm="12">
                  <p class="font-poppings text-center login-text mb-5 `" > Reset Your Password</p>
                </d-col>
              </d-row>
                  ...
                  <d-form>
                    ...
                    <div class="form-group mb-lg-4 mb-5">
                      ...
                      <d-input-group seamless>
                        ...
                        <d-input :type="type"  class="form-control "  v-model="form.confirm_password" placeholder="Password" required/>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async submit() {
        try {
          let res = await axios.post(`${process.env.VUE_APP_API}/admin/password/update`, this.form,
            {
              headers: {
