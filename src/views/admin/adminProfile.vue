          ...
          <d-card-body class="p-0">
            ...
            <div class="border-bottom clearfix d-flex">
              <d-nav tabs class="border-0 mt-auto mx-4 pt-2">
                <d-nav-item active>Create a New Admin Account</d-nav-item>
              </d-nav>
            </div>
            ...
            <d-form class="py-4">
              ...
              <d-form-row class="mx-4">
                ...
                <d-col lg="4">
                  ...
                  <d-button  type="file"  size="sm" class="btn-white d-table mx-auto mt-4"><i class="material-icons">&#xE2C3;</i> Upload Image</d-button>
                </d-col>
              ...
              <d-form-row class="mx-4">
                ...
                <d-col class="d-flex">
                  <d-checkbox checked class="ml-auto my-auto" id="notificationsToggle" toggle/>
