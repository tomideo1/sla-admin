          ...
          <d-card-body class="p-0">
            ...
            <d-form class="py-4" @submit="handleInput" validated>
                ...
                <d-col lg="12">
                  <d-form-row>
                    ...
                    <d-col md="6" class="form-group">
                      ...
                      <d-input type="text" v-model="form.first_name" id="first_name" required />
                      <d-form-invalid-feedback>Please provide your  first name!</d-form-invalid-feedback>
                    ...
                    <d-col md="6" class="form-group">
                      ...
                      <d-input type="text" v-model="form.last_name" id="lastName"  required />
                      <d-form-invalid-feedback>Please provide your last name!</d-form-invalid-feedback>
                    </d-col>
                    ...
                    <d-col md="6" class="form-group">
                      ...
                      <d-input-group seamless>
                        ...
                        <d-input id="phone" v-model="form.phone_number" type="tel" required />
                      </d-input-group>
                      <d-form-invalid-feedback>Please provide your  phone number!</d-form-invalid-feedback>
                    </d-col>
                    ...
                    <d-col md="6" class="form-group">
                      ...
                      <d-input-group seamless>
                        ...
                        <d-form-input id="emailAddress" type="email" v-model="form.email" required >
              ...
              <d-card-footer class="border-top">
                <d-button size="sm" type="submit" class="btn-accent ml-auto d-table mr-3">
                  Create Admin
    ...
    export default {
      ...
      methods:{
        ...
        async submit() {
          ...
          try {
            let res = await axios.post(`${process.env.VUE_APP_API}/admin/create`, this.form,
              {
                headers: {
