<template>
  <d-container fluid class="main-content-container px-4 pb-4">
    ...
    <v-client-table
      ...
      class="dataTables_wrapper file-manager file-manager-list"
    >
      <!-- File Uploader -->
      ...
      <div slot="icon" slot-scope="props" class="file-manager__item-icon">
        <div>
          <i v-if="props.row.type === 'Directory'" class="material-icons"
            >&#xE2C7;</i
          >
      ...
      <div slot="name" slot-scope="props" class="text-left">
        ...
        <span class="file-manager__item-meta"
          >Last opened {{ props.row.lastOpened }} ago.</span
        >
      </div>
      ...
      >
        <d-button
          theme="primary"
          class="btn-white"
          @click="handleActionClick('edit', props.row.id)"
        >
          <i class="material-icons">&#xE254;</i>
        </d-button>
        <d-button
          theme="danger"
          @click="handleActionClick('delete', props.row.id)"
        >
          <i class="material-icons">&#xE872;</i>
        </d-button>
      </d-button-group>
