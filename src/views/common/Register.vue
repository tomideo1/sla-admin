    ...
    <d-row no-gutters class="h-100">
      <d-col lg="3" md="5" class="auth-form mx-auto my-auto">
          ...
          <d-card-body>
            ...
            <d-form>
              ...
              <div class="form-group mb-3 d-table mx-auto">
                <d-checkbox value="agree_tc"
                  >I agree with the
                  <a href="#">Terms & Conditions</a>.</d-checkbox
                >
              </div>
              <d-button pill type="submit" class="btn-accent d-table mx-auto"
                >Create Account</d-button
              >
            </d-form>
          </d-card-body>
        ...
        <div class="auth-form__meta d-flex mt-4">
          ...
          >
          <router-link tag="a" to="register" class="ml-auto"
            >Sign In?</router-link
          >
        </div>
      </d-col>
