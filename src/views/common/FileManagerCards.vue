    ...
    <div class="file-manager file-manager-cards">
        ...
        <d-row no-gutters class="p-2">
          <d-col lg="3" class="mb-2 mb-lg-0">
            <d-form action="POST">
              <d-input-group seamless>
                ...
                <d-input
                  size="sm"
                  class="file-manager-cards__search"
          ...
          <d-col>
            <div class="d-flex ml-lg-auto my-auto">
              ...
              <d-button
                class="btn-sm btn-accent d-inline-block ml-auto ml-lg-0"
              >
      ...
      <d-row>
        <d-col lg="3" v-for="(dir, idx) in filesData.directories" :key="idx">
          <div
            @click="handleItemClick('directories', dir)"
            :class="[
      ...
      <d-row>
        <d-col lg="3" sm="6" v-for="(file, idx) in filesData.files" :key="idx">
          <div
            ...
            @click="handleItemClick('files', file)"
          >
            ...
            <d-card-footer class="border-top">
              ...
              <span class="file-manager__item-size ml-auto">{{
                file.size
              }}</span>
            </d-card-footer>
          </div>
